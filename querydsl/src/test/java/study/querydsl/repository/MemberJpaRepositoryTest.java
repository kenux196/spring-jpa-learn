...
class MemberJpaRepositoryTest {
    ...
    public void basicTest() {
        ...
        List<Member> resultAll = jpaRepository.findAll();
        assertThat(resultAll).containsExactly(member);

        List<Member> result = jpaRepository.findByUsername("member1");
    ...
    public void querydslTest() {
        ...
        List<Member> resultAll = jpaRepository.findAllQuerydsl();
        assertThat(resultAll).containsExactly(member);

        List<Member> result = jpaRepository.findByUsernameQuerydsl("member1");
        assertThat(result).containsExactly(member);
    }
